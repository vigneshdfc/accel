...
export const relationshipData = [
  {
    ...
    founders: ["Jeff Shiner (CEO)", "Roustem Karimov", "Dave Teare"],
    partners: ["Arun Mathew", "Ethan Choi"],
  },
  {
    title: "ada",
    logo: ada,
  ...
  },
  {
    ...
    founders: ["Michel Tricot", "John Lafleur"],
    partners: ["Amit Kumar"],
  },
  {
    title: "algolia",
    ...
    founders: ["Bernadette Nixon (CEO)", "Nicolas Dessaigne", "Julien Lemoine"],
    partners: ["John Locke", "Nate Niparko", "Philippe Botteri"],
  },
  {
    title: "aura",
    logo: aura,
    ...
    description: [
      ...
      "“Getting the culture right is one of the most tricky but most rewarding things in business. You’ve got to create an environment built on respect and trust, inclusivity, integration, and civility.”",
      "Hari Ravichandran, Founder & CEO",
    ],
    founders: ["Hari Ravichandran (CEO)"],
    partners: ["Sameer Gandhi"],
  },
  {
    title: "away",
    logo: away,
    ...
    description: [
      ...
      "I strongly believe that the best entrepreneurs are driven by passion and curiosity, and that energy is a necessary driving force when creating a business from scratch.”",
      "Jen Rubio, CEO & Co-Founder",
    ],
    founders: ["Jennifer Rubio", "Steph Korey"],
    partners: ["Andrew Braccia"],
  },
  {
    title: "blablacar",
    logo: blablacar,
    ...
    description: [
      ...
      "“Culture and values are critical for any company at any stage – and they’re tested in hard times… you need a strong sense of purpose and to be clear on the problem you’re fixing and why.”",
      "Nicolas Brusson,CEO & CO-Founde",
    ],
    founders: ["Nicolas Brusson", "Frédéric Mazzella", "Francis Nappez"],
    partners: ["Philippe Botteri"],
  },
  {
    title: "blackbuck",
    logo: blackbuck,
    ...
    description: [
      ...
      "“If anything is happening without breaking a sweat, then there is some problem: stay calm, focussed, and play point by point.”",
      "Rajesh Yabaji, CEO & Co-Founder",
    ],
    founders: ["Rajesh Yabaji", "Ramasubramanian B", "Chanakya Hridaya"],
    partners: ["Anand Daniel", "Arun Mathew"],
  },
  {
    title: "browserstack",
    logo: browserstack,
    ...
    description: [
      ...
      "We believe in solving real problems. We solve real problems that matter to our customers and us. We don't chase ideas and trends. We solve problems for long-term value creation over short-term results.",
      "Ritesh Arora, Co-founder & CEO",
    ],
    founders: ["Ritesh Arora", "Nakul Aggarwal"],
    partners: ["Nate Niparko", "Ryan Sweeney", "Shekhar Kirani"],
  },
  {
    title: "captivate IQ",
    logo: captivate,
  ...
  },
  {
    ...
    description: [
      ...
      "“One lesson I’ve learned is you have to assemble an extraordinary team. One of our core values and beliefs is that the best team wins. Every time I’ve stayed true to that value, it was extraordinary.”",
      "Alexander Rinke, CEO & Co-Founder",
    ],
    founders: ["Alexander Rinke", "Bastian Nominacher", "Martin Klenk"],
    partners: ["Harry Nelis"],
  },
  {
    title: "chainanalysis",
    logo: chain,
    ...
    description: [
      ...
      "Chainalysis' greatest asset is its people. We would not be where we are today without the talent that has chosen to take our idea to bring transparency to cryptocurrency and build the network and data platform we have today, which is used by government agencies, financial institutions, and cryptocurrency businesses across the world. Our people come from all different backgrounds – technology, finance, government service, and much more – to promote a future that offers more financial freedom with less risk.",
      "––Michael Gronager, CEO",
    ],
    founders: ["Michael Gronager", "Jonathan Levin"],
    partners: ["Amit Kumar", "Philippe Botteri"],
  },
  {
    title: "checkr",
    logo: check,
    ...
    description: [
      ...
      "Every startup guru will tell you to be persistent, which is great advice. But it’s much easier to persist when you are thinking about your mission’s impact on society.”",
      "Daniel Yanisse, Co-founder & CEO",
    ],
    founders: ["Daniel Yanisse", "Jonathan Perichon"],
    partners: ["Rich Wong", "Ben Fletcher"],
  },
  {
    title: "chargebee",
    logo: charge,
  ...
  },
  {
    ...
    description: [
      ...
      "There is pressure to transform the industrial world unlike ever before. Leading a company through this massive shift comes down to one thing: people. Success will be determined by the ability to attract, retain, and empower people, making them believers, backers, and drivers of change that is already here.",
      "John Markus Lervik, CEO & Co-founder",
    ],
    founders: ["Geir Engdahl", "Dr. John Markus Lervik"],
    partners: ["Ping Li", "Matt Weigand"],
  },
  {
    title: "cohesity",
    logo: cohesity,
    ...
    founders: ["Mohit Aron", "Sanjay Poonen (CEO)"],
  ...
  },
  {
    ...
    description: [
      ...
      "“We can’t have an open financial system if it is too difficult to use, or restricted to certain groups. Therefore, we have a simple mission: make crypto accessible.”",
      "Chandan Lodha, Co-Founder",
    ],
    founders: ["Jon Lerner", "Chandan Lodha"],
    partners: ["Sagar Sanghvi", "John Locke"],
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      "“There’s a famous line: 'Never let a crisis go to waste.' I think entrepreneurs can really make use of that.”",
      "Mukesh Bansal, Co-Founder",
    ],
    founders: ["Mukesh Bansal", "Ankit Nagori"],
    partners: ["Subrata Mitra"],
  },
  {
    title: "digi",
    logo: digi,
    ...
    description: [
      ...
      "All you need to do is to be smarter than others--there needs to be a distance from the masses. If you can create that distance, you will be successful.",
      "Frank Wang, Founder & CEO",
    ],
    founders: ["Frank Wang"],
    partners: ["Miles Clements", "Sameer Gandhi"],
  },
  {
    title: "discord",
    logo: discord,
    ...
    description: [
      ...
      "It's important, given the position that we're in, that we are proactive in trying to improve the community and the world around us.",
  ...
  },
  {
    ...
    description: [
      ...
      "Our mission has been the same since day one: making our healthcare system more human, efficient, and connected, and building a company of several thousand people sharing humanist values.”",
      "Stanislas Niox-Chateau, Co-Founder & CEO",
    ],
    founders: [
  ...
  },
  {
    ...
    founders: ["Robert S. Cortright"],
    partners: ["Matt Weigand"],
  },
  {
    title: "emeritus",
    logo: emeritus,
    ...
    description: [
      ...
      "You have to love what you do, either the product, or the business, or the transformation it does to people. That is very important.",
      "Ashwin Damera, CEO",
    ],
    founders: ["Ashwin Damera", "Chaitanya Kalipatnapu"],
    partners: ["Anand Daniel", "Manasi Shah"],
  },
  {
    title: "ethos",
    logo: ethos,
  ...
  },
  {
    ...
    description: [
      ...
      "“Our team is our most important asset as we build G2 into the global marketplace where all software buyers and sellers go for trusted insights. In this journey together we're committed to living our PEAK values: Performance, Entrepreneurship, Authenticity, and Kindness.”",
      "Godard Abel, Co-Founder & CEO",
    ],
    founders: [
      "Godard Abel",
    ...
    partners: ["Arun Mathew", "Kevin Efrusy"],
  },
  {
    title: "goat",
    logo: goat,
  ...
  },
  {
    ...
    description: [
      ...
      "“You used to be able to measure the value of a company by its factories, raw materials and goods, but today, that is measured in people. The market for talented people is more competitive than ever, and the key to attracting them is proactively building relationships – even when they aren't looking to change jobs. We want to make that simple for every company in the world.",
      "Steven Bartel, CEO & Co-Founder",
    ],
    founders: ["Steven Bartel", "Nick Bushak"],
    partners: ["Daniel Levine"],
  },
  {
    title: "gocardless",
    logo: gocard,
    ...
    description: [
      ...
      "Reflect on what you want to achieve when founding a business. The motivations are important because if you’re purely in for the end outcome, it’ll be easy to be disappointed. You have to be in it for the journey itself. The vision keeps on evolving, what you think you can achieve keeps getting bigger, and I find that exciting.",
      "Hiroki Takeuchi, Co-founder & CEO",
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "Founded in 2013 by co-founders and co-CEOs Rafael Ilishayev and Yakir Gola, Gopuff’s original concept was mocked up on the back of the founders’ college business class notes after they met as students at Drexel University—and they began delivering late-night snacks out of the back of their Plymouth Voyager soon after. Years later, their business idea and name stuck. In November 2018, Accel partnered with Gopuff and has continued to partner with them as Gopuff expands their footprint in the United States and the United Kingdom.",
    ],
    founders: ["Yakir Gola", "Rafael Ilishayev"],
    partners: ["Ryan Sweeney", "Maya Noeth"],
  },
  {
    title: "hootsuite",
    logo: hootsuite,
    ...
    founders: ["Ryan Holmes", "David Tedman", "Dario Meli"],
    partners: ["Nate Niparko", "Ryan Sweeney"],
  },
  {
    title: "hopin",
    logo: hopin,
  ...
  },
  {
    ...
    founders: ["David Graff", "John Wirtz", "Brian Kaiser"],
    partners: ["Miles Clements"],
  },
  {
    title: "illumino",
    logo: illumio,
    ...
    description: [
      ...
      "The single best piece of career advice I ever received is to figure out what you love and use that passion to fuel your professional growth. I have been passionate about cybersecurity, innovation and solving customer problems as long as I can remember and Illumio created the opportunity to pursue all of them at once. I’ve always enjoyed thinking outside of the box and building things that are meaningfully different. Along with my co-founder PJ Kirner, I fused these passions together to imagine a radically different approach to cybersecurity, Zero Trust and segmentation. I’m still incredibly energized by the opportunity to create something new and to wake up every day focused on what I love most: making our customer as safe as possible in a dangerous cyber world.",
      "Andrew Rubin, CEO & Co-Founder",
    ],
  ...
  },
  {
    ...
    partners: ["Steve Loughlin", "Vas Natarajan"],
  },
  {
    title: "kry",
    logo: kry,
    ...
    description: [
      ...
      "Johannes Schildt, CEO & Co-Founder",
    ],
    founders: [
      "Johannes Schildt",
  ...
  },
  {
    ...
    description: [
      ...
      "“We believe in a future where all creators have ownership of their destiny. Whether creating products, a service or content, we believe companies should be able to be as successful as they want only limited by the people they are creating for. No one should be limited by technology or technology gatekeepers.”",
